...
public class CameraFragmentMainActivityCustoms extends BaseAppActivity {
    ...
    protected int initLayoutId() {
        return R.layout.activity_camerafragment_main_customs;
    }
    ...
    protected void initTitle() {
        ...
        tb_toolbar.setImmerseState(this, true)//是否侵入，默认侵入
                ...
                .setRightTitleListener(new View.OnClickListener() {//有标题监听
                    @Override
                    public void onClick(View v) {
                        mBeans.add(new FunctionDetailBean("activity_camerafragment_main_customs.xml", BASE_RES + "/layout/activity_camerafragment_main_customs.xml"));
                        showDetail();
                    }
                });
    }
