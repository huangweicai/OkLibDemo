...
import com.bmoblib.bean.LittleKnowledge;
import com.bmoblib.bean.WindowRelated;
import com.hwc.oklib.R;
import com.hwc.oklib.adapter.MainRvAdapter;
    ...
    private void requestNet() {
        switch (type) {
            ...
            case 3:
                ...
                break;
            case 4:
                BmobQueryHelp.queryLittleKnowledge(page, new BmobQueryHelp.OnLittleKnowledgeListener() {
                    @Override
                    public void result(List<LittleKnowledge> object, BmobException e) {
                        if (e == null) {
                            String fastJsonStr = FastJsonUtil.list2Json(object);
                            mainList.clear();
                            mainList = FastJsonUtil.json2List(fastJsonStr, MainBean.class);
