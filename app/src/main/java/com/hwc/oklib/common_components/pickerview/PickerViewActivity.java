package com.hwc.oklib.common_components.pickerview;
...
import com.hwc.oklib.common_components.pickerview.bean.CardBean;
import com.hwc.oklib.common_components.pickerview.bean.ProvinceBean;
import com.hwc.oklib.view.CommonToolBar;
import com.hwc.oklib.view.pickerview.OptionsPickerView;
import com.hwc.oklib.view.pickerview.TimePickerView;
import com.hwc.oklib.view.pickerview.listener.CustomListener;
 ...
 * 描述：PickerView数据采集使用演示
 */
public class PickerViewActivity extends BaseAppActivity implements View.OnClickListener {
    ...
    protected void initTitle() {
        ...
        tb_toolbar.setImmerseState(this, true)//是否侵入，默认侵入
                ...
                .setRightTitleListener(new View.OnClickListener() {//有标题监听
                    @Override
                    public void onClick(View v) {
                        mBeans.add(new FunctionDetailBean("activity_pickerview.xml", BASE_RES +"/layout/activity_pickerview.xml"));
                        showDetail();
                    }
                });
    }
