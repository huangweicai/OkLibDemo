package com.oklib.view.pattern_lock;
...
import com.oklib.view.pattern_lock.listener.PatternLockViewListener;
import com.oklib.view.pattern_lock.utils.PatternLockUtils;
import com.oklib.view.pattern_lock.utils.ResourceUtils;
...
import static com.oklib.view.pattern_lock.PatternLockView.AspectRatio.ASPECT_RATIO_HEIGHT_BIAS;
import static com.oklib.view.pattern_lock.PatternLockView.AspectRatio.ASPECT_RATIO_SQUARE;
import static com.oklib.view.pattern_lock.PatternLockView.AspectRatio.ASPECT_RATIO_WIDTH_BIAS;
import static com.oklib.view.pattern_lock.PatternLockView.PatternViewMode.AUTO_DRAW;
import static com.oklib.view.pattern_lock.PatternLockView.PatternViewMode.CORRECT;
import static com.oklib.view.pattern_lock.PatternLockView.PatternViewMode.WRONG;
    ...
    public PatternLockView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mNormalStateColor = typedArray.getColor(R.styleable.PatternLockView_normalStateColor,
                    ResourceUtils.getColor(getContext(), R.color.lock_view_white));
            ...
            mWrongStateColor = typedArray.getColor(R.styleable.PatternLockView_wrongStateColor,
                    ResourceUtils.getColor(getContext(), R.color.lock_view_pomegranate));
