...
public class MiClockView extends View {
   ...
   public MiClockView(Context context, AttributeSet attrs, int defStyleAttr) {
       ...
       TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.oklib_MiClockView, defStyleAttr, 0);
       mBackgroundColor = ta.getColor(R.styleable.oklib_MiClockView_oklib_mv_backgroundColor, Color.parseColor("#237EAD"));
       setBackgroundColor(mBackgroundColor);
       mLightColor = ta.getColor(R.styleable.oklib_MiClockView_oklib_mv_lightColor, Color.parseColor("#ffffff"));
       mDarkColor = ta.getColor(R.styleable.oklib_MiClockView_oklib_mv_darkColor, Color.parseColor("#80ffffff"));
       mTextSize = ta.getDimension(R.styleable.oklib_MiClockView_oklib_mv_textSize, sp2px(context, 14));
       ta.recycle();
