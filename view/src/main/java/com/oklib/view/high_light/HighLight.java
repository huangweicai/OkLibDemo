package com.oklib.view.high_light;
...
import com.oklib.view.high_light.util.ViewUtils;
...
//            if (!rect.equals(viewPosInfo.rectF))//TODO bug dismissed...fc...
    ...
    private static final class ListenersHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case CLICK:
                    ((OnClickCallback) msg.obj).onClick();
                    break;
                case REMOVE:
                    ((OnRemoveCallback) msg.obj).onRemove();
                    break;
                case SHOW:
                    ((OnShowCallback) msg.obj).onShow(hightLightView);
                    break;
                case NEXT:
                    ...
                    ((OnNextCallback) msg.obj).onNext(hightLightView, targetView, tipView);
                    break;
                case LAYOUT:
                    ((OnLayoutCallback) msg.obj).onLayouted();
                    break;
            }
        }
    }
