...
public class SuperDrawable extends RelativeLayout {
    ...
    public SuperDrawable(Context context) {
        super(context);
        init(null);
    }

    public SuperDrawable(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public SuperDrawable(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray =
                    getContext().obtainStyledAttributes(attrs, R.styleable.oklib_SuperTextView);
            corner = typedArray.getDimension(R.styleable.oklib_SuperTextView_oklib_corner, DEFAULT_CORNER);
            leftTopCornerEnable =
                    typedArray.getBoolean(R.styleable.oklib_SuperTextView_oklib_left_top_corner, false);
            rightTopCornerEnable =
                    typedArray.getBoolean(R.styleable.oklib_SuperTextView_oklib_right_top_corner, false);
            leftBottomCornerEnable =
                    typedArray.getBoolean(R.styleable.oklib_SuperTextView_oklib_left_bottom_corner, false);
            rightBottomCornerEnable =
                    typedArray.getBoolean(R.styleable.oklib_SuperTextView_oklib_right_bottom_corner, false);
            solid = typedArray.getColor(R.styleable.oklib_SuperTextView_oklib_solid, DEFAULT_SOLID);
            strokeWidth = typedArray.getDimension(R.styleable.oklib_SuperTextView_oklib_stroke_width,
                    DEFAULT_STROKE_WIDTH);
            strokeColor =
                    typedArray.getColor(R.styleable.oklib_SuperTextView_oklib_stroke_color, DEFAULT_STROKE_COLOR);
            drawable = typedArray.getDrawable(R.styleable.oklib_SuperTextView_oklib_state_drawable);
            drawableWidth =
                    typedArray.getDimension(R.styleable.oklib_SuperTextView_oklib_state_drawable_width, 0);
            drawableHeight =
                    typedArray.getDimension(R.styleable.oklib_SuperTextView_oklib_state_drawable_height, 0);
            drawablePaddingLeft =
                    typedArray.getDimension(R.styleable.oklib_SuperTextView_oklib_state_drawable_padding_left, 0);
            drawablePaddingTop =
                    typedArray.getDimension(R.styleable.oklib_SuperTextView_oklib_state_drawable_padding_top, 0);
            isShowState = typedArray.getBoolean(R.styleable.oklib_SuperTextView_oklib_isShowState, false);
            stateDrawableMode = typedArray.getInteger(R.styleable.oklib_SuperTextView_oklib_state_drawable_mode,
                    DEFAULT_STATE_DRAWABLE_MODE);
            textStroke = typedArray.getBoolean(R.styleable.oklib_SuperTextView_oklib_text_stroke, false);
            textStrokeColor = typedArray.getColor(R.styleable.oklib_SuperTextView_oklib_text_stroke_color,
                    DEFAULT_TEXT_STROKE_COLOR);
            textFillColor = typedArray.getColor(R.styleable.oklib_SuperTextView_oklib_text_fill_color,
                    DEFAULT_TEXT_FILL_COLOR);
            textStrokeWidth = typedArray.getDimension(R.styleable.oklib_SuperTextView_oklib_text_stroke_width,
                    DEFAULT_TEXT_STROKE_WIDTH);
            autoAdjust = typedArray.getBoolean(R.styleable.oklib_SuperTextView_oklib_autoAdjust, false);
            shaderStartColor =
                    typedArray.getColor(R.styleable.oklib_SuperTextView_oklib_shaderStartColor, 0);
            shaderEndColor =
                    typedArray.getColor(R.styleable.oklib_SuperTextView_oklib_shaderEndColor, 0);
            shaderMode = typedArray.getInteger(R.styleable.oklib_SuperTextView_oklib_shaderMode, 0);
            shaderEnable = typedArray.getBoolean(R.styleable.oklib_SuperTextView_oklib_shaderEnable, false);
            typedArray.recycle();
        }
    }
...
//        }
     ...
     */
    public SuperDrawable setCorner(float corner) {
        this.corner = corner;
        postInvalidate();
     ...
     * @return SuperTextView
     */
    public SuperDrawable setSolid(int solid) {
        this.solid = solid;
        postInvalidate();
     ...
     * @return SuperTextView
     */
    public SuperDrawable setStrokeWidth(float strokeWidth) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setStrokeColor(int strokeColor) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setAdjuster(Adjuster adjuster) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setTextStroke(boolean textStroke) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setTextStrokeColor(int textStrokeColor) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setTextFillColor(int textFillColor) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setTextStrokeWidth(float textStrokeWidth) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setAutoAdjust(boolean autoAdjust) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setLeftTopCornerEnable(boolean leftTopCornerEnable) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setRightTopCornerEnable(boolean rightTopCornerEnable) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setLeftBottomCornerEnable(boolean leftBottomCornerEnable) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setRightBottomCornerEnable(boolean rightBottomCornerEnable) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setDrawable(Drawable drawable) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setDrawable(int drawableRes) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setShowState(boolean showState) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setStateDrawableMode(int stateDrawableMode) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setDrawableWidth(float drawableWidth) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setDrawableHeight(float drawableHeight) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setDrawablePaddingLeft(float drawablePaddingLeft) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setDrawablePaddingTop(float drawablePaddingTop) {
    ...
    /**
     * @param shaderStartColor 设置渐变起始色。需要调用{@link SuperDrawable#setShaderEnable(boolean)}后才能生效。会触发一次重绘。
     * @return SuperTextView
     */
    public SuperDrawable setShaderStartColor(int shaderStartColor) {
    ...
    /**
     * @param shaderEndColor 设置渐变结束色。需要调用{@link SuperDrawable#setShaderEnable(boolean)}后才能生效。会触发一次重绘。
     * @return SuperTextView
     */
    public SuperDrawable setShaderEndColor(int shaderEndColor) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setShaderMode(int shaderMode) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setShaderEnable(boolean shaderEnable) {
     ...
     * @return SuperTextView
     */
    public SuperDrawable setFrameRate(int frameRate) {
        if (frameRate > 0) {
    ...
    /**
     * 启动动画。需要设置{@link SuperDrawable#setAutoAdjust(boolean)}为true才能看到。
     */
     ...
     * 这具有非常重要的意义。比如，默认实现的{@link }能够动态的调整文字的大小。
     * 当然，你可以用它来实现各种各样的效果。
    ...
    public static abstract class Adjuster {
         ...
         */
        protected abstract void adjust(SuperDrawable v, Canvas canvas);
         ...
         */
        public boolean onTouch(SuperDrawable v, MotionEvent event) {
            return false;
        }
...
//
//        @Override
//        public void adjust(SuperDrawable v, Canvas canvas) {
//            int length = v.length();
