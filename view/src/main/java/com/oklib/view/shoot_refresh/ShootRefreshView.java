...
public class ShootRefreshView extends View implements IRefreshStatus {
    ...
    private void resolveAttrs(Context context, AttributeSet attrs) {
        ...
        mStrokeColor = ta.getColor(R.styleable.ShootRefreshView_shootview_strokeColor,
                DEFAULT_STROKE_COLOR);
        mGradientStartColor = ta.getColor(R.styleable.ShootRefreshView_shootview_gradientStartColor,
                DEFAULT_GRADIENT_START_COLOR);
        mGradientEndColor =
                ta.getColor(R.styleable.ShootRefreshView_shootview_gradientEndColor, DEFAULT_GRADIENT_END_COLOR);
        mStrokeWidth =
                ta.getDimensionPixelSize(R.styleable.ShootRefreshView_shootview_strokeWidth,
