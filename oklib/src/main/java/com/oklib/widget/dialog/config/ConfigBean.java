package com.oklib.widget.dialog.config;
...
支持gridview 或者recylerview*/
    ...
    @Override
    public ConfigBean setBtnColor(@ColorRes int neutralColor, @ColorRes int negativeColor, @ColorRes int positiveColor) {
        if (btn1Color > 0)
            this.btn1Color = positiveColor;
        if (btn2Color > 0)
            this.btn2Color = negativeColor;
        if (btn3Color > 0)
            this.btn3Color = neutralColor;
        return this;
    }
    ...
    @Override
    public ConfigBean setBtnText(CharSequence neutralText, @Nullable CharSequence negativeText, @Nullable CharSequence positiveText) {
        this.text1 = positiveText;
        this.text2 = negativeText;
        this.text3 = neutralText;
        return this;
    }
