...
public class DefaultConfig {
    ...
    int iosBtnColor = R.color.oklib_ios_btntext_blue;


    public  static @ColorRes
    int lvItemTxtColor = R.color.oklib_text_item_33;

    public static  @ColorRes
    int mdBtnColor = R.color.oklib_ios_btntext_blue;

    public static @ColorRes
    int titleTxtColor = R.color.oklib_text_title_11;
    public static @ColorRes
    int msgTxtColor = R.color.oklib_text_title_11;
    public static @ColorRes
    int inputTxtColor = R.color.oklib_text_input_44;
