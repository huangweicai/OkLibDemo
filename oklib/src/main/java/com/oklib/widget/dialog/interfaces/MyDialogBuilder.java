...
import com.oklib.widget.dialog.adapter.SuperLvAdapter;
import com.oklib.widget.dialog.adapter.SuperLvHolder;
import com.oklib.widget.dialog.bottomsheet.BottomSheetBean;
import com.oklib.widget.dialog.bottomsheet.BsGvHolder;
import com.oklib.widget.dialog.bottomsheet.BsLvHolder;
import com.oklib.widget.dialog.config.ConfigBean;
import com.oklib.widget.dialog.config.DefaultConfig;
import com.oklib.widget.dialog.view.GifMovieView;
import com.oklib.widget.dialog.view.IosActionSheetHolder;
import com.oklib.widget.dialog.view.IosAlertDialogHolder;
import com.oklib.widget.dialog.view.IosCenterItemHolder;
...
public  class MyDialogBuilder {
   ...
   protected ConfigBean buildByType(ConfigBean bean){
    ...
    private void buildBottomSheetLv(final ConfigBean bean) {
        final BottomSheetDialog dialog = new BottomSheetDialog(bean.context);
        LinearLayout root = (LinearLayout) View.inflate(bean.context, R.layout.oklib_bottomsheet_lv,null);
    ...
    protected  ConfigBean buildLoading(ConfigBean bean){
        View root = View.inflate(bean.context, R.layout.oklib_loading,null);
    ...
    protected  ConfigBean buildMdLoading(ConfigBean bean){
        View root = View.inflate(bean.context, R.layout.oklib_progressview_wrapconent,null);
        TextView tvMsg = (TextView) root.findViewById(R.id.loading_msg);
        StyledDialog.setTv_msg(tvMsg);
        tvMsg.setText(bean.msg);
        bean.dialog.setContentView(root);
    ...
    protected  ConfigBean buildBottomItemDialog(ConfigBean bean){
        ...
        window.setWindowAnimations(R.style.oklib_mystyle);
        return bean;
    }
