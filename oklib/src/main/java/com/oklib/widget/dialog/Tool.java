...
public class Tool {
        ...
        if(btnNegative !=null){
            ...
            if (bean.btn2Color > 0 )
                if(bean.btn2Color == DefaultConfig.iosBtnColor ){
                    btnNegative.setTextColor(getColor(null, R.color.oklib_text_gray));
                }else {
    ...
    private static void setBg(ConfigBean bean) {
        if (bean.alertDialog!= null){
            bean.alertDialog.getWindow().setBackgroundDrawableResource(R.drawable.oklib_shadow);
        }else {
            if(bean.type == DefaultConfig.TYPE_BOTTOM_SHEET_GRID
                ...
                bean.dialog.getWindow().setBackgroundDrawableResource(R.drawable.oklib_shadow);
            }
           ...
           // listView.getAdapter().
            if(listView!=null && listView.getAdapter() !=null){
                ...
                for(int i=0;i<count;i++){
                    ...
                    Log.e("dd",itemView+"-----"+ i);
                    if(itemView !=null) {
                        itemView.setCheckMarkDrawable(R.drawable.oklib_bg_toast);
