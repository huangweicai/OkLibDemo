 ...
 * 3、贝塞尔曲线
 */
public class FllowerAnimView extends View implements ValueAnimator.AnimatorUpdateListener {
    ...
    public FllowerAnimView(Context context) {
        super(context);
        init(context);
    }

    public FllowerAnimView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public FllowerAnimView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public FllowerAnimView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
