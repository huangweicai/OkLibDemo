package com.oklib.view.pickerview.lib;
...
import com.oklib.R;
import com.oklib.view.pickerview.adapter.WheelAdapter;
import com.oklib.view.pickerview.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
       ...
       /* textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.oklib_pickerview_textsize);//默认大小
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.oklib_pickerview, 0, 0);
            mGravity = a.getInt(R.styleable.oklib_pickerview_oklib_pickerview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.oklib_pickerview_oklib_pickerview_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.oklib_pickerview_oklib_pickerview_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.oklib_pickerview_oklib_pickerview_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.oklib_pickerview_oklib_pickerview_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.oklib_pickerview_oklib_pickerview_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
