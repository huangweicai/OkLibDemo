package com.oklib.view.pickerview;
...
import com.oklib.view.pickerview.listener.CustomListener;
import com.oklib.view.pickerview.view.BasePickerView;
import com.oklib.view.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public static class Builder {
        private int layoutRes = R.layout.oklib_pickerview_time;
        private CustomListener customListener;
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.oklib_pickerview_time, contentContainer);
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R.string.oklib_pickerview_submit) : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources().getString(R.string.oklib_pickerview_cancel) : Str_Cancel);
