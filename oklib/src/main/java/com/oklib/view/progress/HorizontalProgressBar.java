...
public class HorizontalProgressBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.oklib_HorizontalProgressBar);
        max = a.getInteger(R.styleable.oklib_HorizontalProgressBar_oklib_pb_max, 100);
        progress = a.getInteger(R.styleable.oklib_HorizontalProgressBar_oklib_pb_progress, 0);
        bgColor = a.getColor(R.styleable.oklib_HorizontalProgressBar_oklib_pb_bg_color, 0xff3F51B5);
        progressColor = a.getColor(R.styleable.oklib_HorizontalProgressBar_oklib_pb_pb_color, 0xffFF4081);
        padding = a.getDimensionPixelSize(R.styleable.oklib_HorizontalProgressBar_oklib_pb_padding, 2);
        a.recycle();
    }
