...
public class StateButton extends AppCompatButton {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.oklib_StateButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.oklib_StateButton_oklib_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.oklib_StateButton_oklib_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.oklib_StateButton_oklib_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.oklib_StateButton_oklib_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.oklib_StateButton_oklib_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.oklib_StateButton_oklib_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.oklib_StateButton_oklib_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.oklib_StateButton_oklib_radius, 0);
        mRound = a.getBoolean(R.styleable.oklib_StateButton_oklib_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.oklib_StateButton_oklib_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.oklib_StateButton_oklib_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.oklib_StateButton_oklib_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.oklib_StateButton_oklib_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.oklib_StateButton_oklib_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.oklib_StateButton_oklib_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.oklib_StateButton_oklib_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.oklib_StateButton_oklib_unableStrokeColor, 0);
        setStroke();
