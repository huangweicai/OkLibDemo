...
public class StateImageView extends AppCompatImageView {
    ...
    public StateImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.oklib_StateImageView);

        mNormalDrawable = a.getDrawable(R.styleable.oklib_StateImageView_oklib_normalBackground);
        mPressedDrawable = a.getDrawable(R.styleable.oklib_StateImageView_oklib_pressedBackground);
        mUnableDrawable = a.getDrawable(R.styleable.oklib_StateImageView_oklib_unableBackground);
        setStateBackground(mNormalDrawable, mPressedDrawable, mUnableDrawable);

        mDuration = a.getInteger(R.styleable.oklib_StateImageView_oklib_AnimationDuration, mDuration);
