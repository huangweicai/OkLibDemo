...
//
//import com.oklib.glideview.R;
//import com.oklib.glideview.util.DisplayUtil;
//
...
//        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.oklib_CircleProgressView);
//        mProgressStyle = ta.getInt(R.styleable.oklib_CircleProgressView_oklib_cpv_progressStyle, ProgressStyle.NORMAL);
//        // 获取三种风格通用的属性
//        mNormalBarSize = (int) ta.getDimension(R.styleable.oklib_CircleProgressView_oklib_cpv_progressNormalSize, mNormalBarSize);
//        mNormalBarColor = ta.getColor(R.styleable.oklib_CircleProgressView_oklib_cpv_progressNormalColor, mNormalBarColor);
//
//        mReachBarSize = (int) ta.getDimension(R.styleable.oklib_CircleProgressView_oklib_cpv_progressReachSize, mReachBarSize);
//        mReachBarColor = ta.getColor(R.styleable.oklib_CircleProgressView_oklib_cpv_progressReachColor, mReachBarColor);
//
//        mTextSize = (int) ta.getDimension(R.styleable.oklib_CircleProgressView_oklib_cpv_progressTextSize, mTextSize);
//        mTextColor = ta.getColor(R.styleable.oklib_CircleProgressView_oklib_cpv_progressTextColor, mTextColor);
//        mTextSkewX = ta.getDimension(R.styleable.oklib_CircleProgressView_oklib_cpv_progressTextSkewX, 0);
//        if (ta.hasValue(R.styleable.oklib_CircleProgressView_oklib_cpv_progressTextSuffix)) {
//            mTextSuffix = ta.getString(R.styleable.oklib_CircleProgressView_oklib_cpv_progressTextSuffix);
//        }
//        if (ta.hasValue(R.styleable.oklib_CircleProgressView_oklib_cpv_progressTextPrefix)) {
//            mTextPrefix = ta.getString(R.styleable.oklib_CircleProgressView_oklib_cpv_progressTextPrefix);
//        }
//        mTextVisible = ta.getBoolean(R.styleable.oklib_CircleProgressView_oklib_cpv_progressTextVisible, mTextVisible);
//
//        mRadius = (int) ta.getDimension(R.styleable.oklib_CircleProgressView_oklib_cpv_radius, mRadius);
...
//                mStartArc = ta.getInt(R.styleable.oklib_CircleProgressView_oklib_cpv_progressStartArc, 0) + 270;
//                mInnerPadding = (int) ta.getDimension(R.styleable.oklib_CircleProgressView_oklib_cpv_innerPadding, mInnerPadding);
//                mOuterColor = ta.getColor(R.styleable.oklib_CircleProgressView_oklib_cpv_outerColor, mReachBarColor);
//                mOuterSize = (int) ta.getDimension(R.styleable.oklib_CircleProgressView_oklib_cpv_outerSize, mOuterSize);
//                mReachBarSize = 0;// 将画笔大小重置为0
//                mNormalBarSize = 0;
//                if (!ta.hasValue(R.styleable.oklib_CircleProgressView_oklib_cpv_progressNormalColor)) {
...
//                mReachCapRound = ta.getBoolean(R.styleable.oklib_CircleProgressView_oklib_cpv_reachCapRound, true);
//                mStartArc = ta.getInt(R.styleable.oklib_CircleProgressView_oklib_cpv_progressStartArc, 0) + 270;
//                if (ta.hasValue(R.styleable.oklib_CircleProgressView_oklib_cpv_innerBackgroundColor)) {
//                    mInnerBackgroundColor = ta.getColor(R.styleable.oklib_CircleProgressView_oklib_cpv_innerBackgroundColor, Color.argb(0, 0, 0, 0));
