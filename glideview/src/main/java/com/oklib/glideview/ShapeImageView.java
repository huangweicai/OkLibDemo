...
//       if (attrs != null) {
//           TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.oklib_ShapeImageViewStyle);
//           borderWidth = array.getDimensionPixelOffset(R.styleable.oklib_ShapeImageViewStyle_oklib_siv_border_width, borderWidth);
//           borderColor = array.getColor(R.styleable.oklib_ShapeImageViewStyle_oklib_siv_border_color, borderColor);
//           radius = array.getDimensionPixelOffset(R.styleable.oklib_ShapeImageViewStyle_oklib_siv_radius, radius);
//           pressedAlpha = array.getFloat(R.styleable.oklib_ShapeImageViewStyle_oklib_siv_pressed_alpha, pressedAlpha);
//           if (pressedAlpha > 1) pressedAlpha = 1;
//           pressedColor = array.getColor(R.styleable.oklib_ShapeImageViewStyle_oklib_siv_pressed_color, pressedColor);
//           shapeType = array.getInteger(R.styleable.oklib_ShapeImageViewStyle_oklib_siv_shape_type, shapeType);
//           array.recycle();
//       }
//
//       initPressedPaint();
